...
/**
 * Tests {@link PreorderTraversalIterative} solution.
 */
@RunWith(Parameterized.class)
public class PreorderTraversalIterativeTest {
    private final TreeNode root;
    private final List<Integer> expected;

    public PreorderTraversalIterativeTest(TreeNode root, List<Integer> expected) {
        this.root = root;
    ...
    public void preorderItr() throws Exception {
        List<Integer> actual = PreorderTraversalIterative.preorderItr(root);
